...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menuss"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menuss"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menuss"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menuss_menuData["data"]) && is_array($menuss_menuData["data"]) && !empty($menuss_menuData["data"]))
    {
        foreach($menuss_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($menuss_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
