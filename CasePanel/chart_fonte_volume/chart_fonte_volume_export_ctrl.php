<?php
@session_start() ;
$_SESSION['scriptcase']['chart_fonte_volume']['sc_process_barr'] = true;
require_once('../chart_fonte_volume/index.php');
unset($_SESSION['scriptcase']['chart_fonte_volume']['sc_process_barr']);
$ExportCtrl = new chart_fonte_volume_export_control;
$ExportCtrl->Export_barr();

class chart_fonte_volume_export_control
{
