<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_perfil']          = "host_oficial";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'Web_Case_IoT_V_1_12', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'])) {
               $_SESSION['scriptcase']['app_grid_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'];
           }
       }
   }
