...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____app_grid_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____app_grid_sec_groups"]);
   }
