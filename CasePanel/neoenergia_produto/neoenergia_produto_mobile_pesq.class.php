...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_produto_cond" name="produto_cond" onChange="nm_campos_between(document.getElementById('id_vis_produto'), this, 'produto')">
      ...
      <br><span id="id_hide_produto"  <?php echo $str_hide_produto?>><INPUT  type="text" id="SC_produto" name="produto" value="<?php echo NM_encode_input($produto) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
