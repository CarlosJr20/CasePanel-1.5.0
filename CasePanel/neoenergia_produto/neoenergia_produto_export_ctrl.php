<?php
@session_start() ;
$_SESSION['scriptcase']['neoenergia_produto']['sc_process_barr'] = true;
require_once('../neoenergia_produto/index.php');
unset($_SESSION['scriptcase']['neoenergia_produto']['sc_process_barr']);
$ExportCtrl = new neoenergia_produto_export_control;
$ExportCtrl->Export_barr();

class neoenergia_produto_export_control
{
