...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____neoenergia_lancamento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____neoenergia_lancamento"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['neoenergia_lancamento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['neoenergia_lancamento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['neoenergia_lancamento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['neoenergia_lancamento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['neoenergia_lancamento']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>neoenergia_lancamento</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['neoenergia_lancamento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['neoenergia_lancamento']['embutida_filho'] as $ind => $sc_init)
          {
