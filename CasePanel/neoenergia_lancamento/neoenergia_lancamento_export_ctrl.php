<?php
@session_start() ;
$_SESSION['scriptcase']['neoenergia_lancamento']['sc_process_barr'] = true;
require_once('../neoenergia_lancamento/index.php');
unset($_SESSION['scriptcase']['neoenergia_lancamento']['sc_process_barr']);
$ExportCtrl = new neoenergia_lancamento_export_control;
$ExportCtrl->Export_barr();

class neoenergia_lancamento_export_control
{
