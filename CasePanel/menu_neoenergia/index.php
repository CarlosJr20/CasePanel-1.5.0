...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_perfil']         = "host_oficial";
    $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo']      = "";
...
class menu_neoenergia_class
{
 ...
 function menu_neoenergia_menu()
 {
    global $menu_neoenergia_menuData, $nm_data_fixa;
...
$path_img_old   = $str_root . $path_link . "menu_neoenergia/img";
...
include_once(dirname(__FILE__) . "/menu_neoenergia_erro.class.php"); 
$this->Erro = new menu_neoenergia_erro();
$str_path = substr($_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_neoenergia']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$menu_neoenergia_menuData         = array();
$menu_neoenergia_menuData['path'] = array();
$menu_neoenergia_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_neoenergia_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_neoenergia_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_neoenergia_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_neoenergia_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_neoenergia_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_neoenergia_menuData['url']['web']   = str_replace("\\", '/', $menu_neoenergia_menuData['url']['web']);
$menu_neoenergia_menuData['path']['root'] = substr($menu_neoenergia_menuData['path']['sys'],  0, -1 * strlen($menu_neoenergia_menuData['url']['web']));
$menu_neoenergia_menuData['path']['app']  = substr($menu_neoenergia_menuData['path']['sys'],  0, strrpos($menu_neoenergia_menuData['path']['sys'],  '/'));
$menu_neoenergia_menuData['path']['link'] = substr($menu_neoenergia_menuData['path']['app'],  0, strrpos($menu_neoenergia_menuData['path']['app'],  '/'));
$menu_neoenergia_menuData['path']['link'] = substr($menu_neoenergia_menuData['path']['link'], 0, strrpos($menu_neoenergia_menuData['path']['link'], '/')) . '/';
$menu_neoenergia_menuData['path']['app'] .= '/';
$menu_neoenergia_menuData['url']['app']   = substr($menu_neoenergia_menuData['url']['web'],  0, strrpos($menu_neoenergia_menuData['url']['web'],  '/'));
$menu_neoenergia_menuData['url']['link']  = substr($menu_neoenergia_menuData['url']['app'],  0, strrpos($menu_neoenergia_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] == "S")
{
    $menu_neoenergia_menuData['url']['link']  = substr($menu_neoenergia_menuData['url']['link'], 0, strrpos($menu_neoenergia_menuData['url']['link'], '/'));
}
$menu_neoenergia_menuData['url']['link']  .= '/';
$menu_neoenergia_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_neoenergia']['sc_apl_link'] = $menu_neoenergia_menuData['url']['link'];
...
include_once("menu_neoenergia_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_neoenergia";
     $_SESSION['scriptcase']['menu_apls']['menu_neoenergia'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_neoenergia']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_neoenergia']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_neoenergia']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_neoenergia']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menu_neoenergia']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_neoenergia']['init']))
{
    $_SESSION['sc_session'][1]['menu_neoenergia']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_neoenergia']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_neoenergia']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_neoenergia'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_neoenergia'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_neoenergia'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
{
    $_SESSION['scriptcase']['sc_menu_del']['menu_neoenergia'][] = trim($Cada_del);
}
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_neoenergia'))
{
    $_SESSION['sc_session'][1]['menu_neoenergia']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_neoenergia'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$menu_neoenergia_menuData['iframe'] = TRUE;
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_neoenergia'];
$menu_neoenergia_menuData['data'] .= "item_22|.|" . $nm_var_lab[0] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $menu_neoenergia_menuData['data'] .= "item_23|..|" . $this->Nm_lang['lang_list_users'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $menu_neoenergia_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}
...
{
    $menu_neoenergia_menuData['data'] .= "item_25|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}
...
{
    $menu_neoenergia_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_32&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}
...
{
    $menu_neoenergia_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $menu_neoenergia_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) == "on")
{
    $menu_neoenergia_menuData['data'] .= "item_30|..|" . $this->Nm_lang['lang_logged_users'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_30&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_logged_users'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_neoenergia_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_neoenergia_menuData['data'] .= "item_29|..|" . $this->Nm_lang['lang_exit'] . "|menu_neoenergia_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_neoenergia_target('_parent') . "|" . "\n";
}

$menu_neoenergia_menuData['data'] .= "item_33|.|" . $nm_var_lab[1] . "||" . $nm_var_hint[0] . "||_self|\n";
$menu_neoenergia_menuData['data'] .= "item_11|..|" . $nm_var_lab[2] . "||" . $nm_var_hint[1] . "||_self|\n";
...
{
    $menu_neoenergia_menuData['data'] .= "item_12|...|" . $nm_var_lab[3] . "|menu_neoenergia_form_php.php?sc_item_menu=item_12&sc_apl_menu=grafico_corrente_maior&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}
...
{
    $menu_neoenergia_menuData['data'] .= "item_16|...|" . $nm_var_lab[4] . "|menu_neoenergia_form_php.php?sc_item_menu=item_16&sc_apl_menu=grafico_consumo_maior&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

$menu_neoenergia_menuData['data'] .= "item_35|..|" . $nm_var_lab[5] . "||" . $nm_var_hint[4] . "||_self|\n";
...
{
    $menu_neoenergia_menuData['data'] .= "item_36|...|" . $nm_var_lab[6] . "|menu_neoenergia_form_php.php?sc_item_menu=item_36&sc_apl_menu=chart_mar_e_brasa_historico_consumo&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}
...
{
    $menu_neoenergia_menuData['data'] .= "item_37|...|" . $nm_var_lab[7] . "|menu_neoenergia_form_php.php?sc_item_menu=item_37&sc_apl_menu=chart_mar_e_brasa_historico_Tarifa_mensal&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

$menu_neoenergia_menuData['data'] .= "item_4|.|" . $_SESSION['usr_name'] . "||" . $nm_var_hint[7] . "|scriptcase__NM__bg__NM__admin_proj.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_neoenergia_menuData['data'] .= "item_9|..|" . $nm_var_lab[8] . "|menu_neoenergia_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_neoenergia_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_neoenergia_menuData['data'] .= "item_6|..|" . $nm_var_lab[9] . "|menu_neoenergia_form_php.php?sc_item_menu=item_6&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_neoenergia_target('_parent') . "|" . "\n";
}


$menu_neoenergia_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
$str_icon = "";
$icon_aba = "";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_neoenergia_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_neoenergia_target('_self') . "\"",
        'sc_id'    => "item_23",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_32&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_30&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_neoenergia_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_neoenergia_target('_parent') . "\"",
        'sc_id'    => "item_29",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_12&sc_apl_menu=grafico_corrente_maior&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_corrente_maior']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_corrente_maior']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_16&sc_apl_menu=grafico_consumo_maior&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_consumo_maior']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_consumo_maior']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_36&sc_apl_menu=chart_mar_e_brasa_historico_consumo&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_mar_e_brasa_historico_consumo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['chart_mar_e_brasa_historico_consumo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_37&sc_apl_menu=chart_mar_e_brasa_historico_Tarifa_mensal&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_mar_e_brasa_historico_Tarifa_mensal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['chart_mar_e_brasa_historico_Tarifa_mensal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_neoenergia_form_php.php?sc_item_menu=item_6&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_neoenergia']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_neoenergia']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_neoenergia');
    $menu_neoenergia_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_neoenergia_help.txt"))
{
    $Arq_WebHelp = file("menu_neoenergia_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_neoenergia_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_neoenergia_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_neoenergia']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_neoenergia']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_neoenergia_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_neoenergia']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_neoenergia_menuData['data'][$i_menu]);
       }
    ...
    $menu_neoenergia_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_neoenergia']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_neoenergia']))
{
    $disable_menu = false;
    foreach ($menu_neoenergia_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_neoenergia']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_neoenergia_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_neoenergia_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_neoenergia_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_neoenergia_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_neoenergia_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_neoenergia_menuData['data'][$chave]['level'];
                        unset($menu_neoenergia_menuData['data'][$chave]);
                }
        }
}
$menu_neoenergia_menuData['data'] = array_values($menu_neoenergia_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_neoenergia_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($menu_neoenergia_menuData['data'][$chave + 1]) && !empty($menu_neoenergia_menuData['data'][$chave + 1]))
            {
                if ($menu_neoenergia_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_neoenergia_menuData['data'][$chave]['level'] >= $menu_neoenergia_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_neoenergia_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_neoenergia_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_neoenergia_menuData['data'][$chave]);
            }
        }
...
/* Cabeçalho HTML */
if ($menu_neoenergia_menuData['iframe'])
{
    $menu_neoenergia_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $menu_neoenergia_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_neoenergia_message.js"></script>
...
Iframe_atual = "menu_neoenergia_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_neoenergia\";\r\n";
echo "Tab_labels['menu_neoenergia'] = \"  Home\";\r\n";
echo "Tab_hints['menu_neoenergia'] = \"  Home\";\r\n";
echo "Tab_abas['menu_neoenergia']   = \"none\";\r\n";
echo "Tab_refresh['menu_neoenergia']   = \"\";\r\n";
echo "Tab_icons['menu_neoenergia'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_neoenergia'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_neoenergia']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_neoenergia']   = \"\";\r\n";
echo "Tab_display['menu_neoenergia']   = \"\";\r\n";
echo "Tab_display_position['menu_neoenergia']   = \"\";\r\n";
echo "Tab_links['menu_neoenergia']   = \"\";\r\n";
         $seq++;
 if(isset($menu_neoenergia_menuData['data']) && !empty($menu_neoenergia_menuData['data']))
 {
   foreach ($menu_neoenergia_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_neoenergia_menuData['data_vertical']) && !empty($menu_neoenergia_menuData['data_vertical']))
 {
   foreach ($menu_neoenergia_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_neoenergia_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_neoenergia'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_neoenergia').hide();
    if (str_id == "")
    {
        $('#iframe_menu_neoenergia').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            if (Tab_iframes[i] != 'menu_neoenergia') 
            {
                Iframe_atual = "menu_neoenergia_" + Tab_iframes[i] + '_iframe';
            }
...
{
    if(str_id === 'menu_neoenergia') { return false; }
    ...
    if (Aba_atual == str_id)
    {
        ...
        if (str_id == "" && Aba_atual != "menu_neoenergia")
        {
            document.getElementById('iframe_menu_neoenergia').click();
        }
        else
        {
            mudaIframe(str_id);
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_neoenergia")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_neoenergia_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_neoenergia', 'menu_neoenergia');
    if (str_target == "menu_neoenergia_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
    ...
    if(str_target != '_blank' && $('#iframe_menu_neoenergia').length)
        $('#iframe_menu_neoenergia')[0].contentWindow.focus();
  }
}
</script>
...
echo $this->menu_neoenergia_escreveMenu($menu_neoenergia_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_neoenergia_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_neoenergia');\" item-href=\"menu_neoenergia_form_php.php?sc_item_menu=menu_neoenergia&sc_apl_menu=home_mar_e_brasa&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_neoenergia_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_neoenergia_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_neoenergia" name="menu_neoenergia_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
 foreach ($menu_neoenergia_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_neoenergia_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_neoenergia').click()";
    echo "</script>";
}
...
/* Controle de Target */
function menu_neoenergia_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('menu_neoenergia_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
...
function menu_neoenergia_target($str_target)
{
    global $menu_neoenergia_menuData;
    ...
    elseif ($menu_neoenergia_menuData['iframe'])
    {
        return 'menu_neoenergia_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_neoenergia_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_neoenergia_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_neoenergia_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_neoenergia_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_neoenergia']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_neoenergia_target( $arr_item['target']) : "_self"; 
           }
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        return  $_SESSION['scriptcase']['menu_neoenergia']['sc_init'][$apl_menu];
   }
...
$_SESSION['scriptcase']['menu_neoenergia']['contr_erro'] = 'off';
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0)
   {
      ...
      {
          $nm_apl_dest = str_replace(".php", "", $nm_apl_dest);
          $nm_apl_dest = $menu_neoenergia_menuData['url']['link'] . $this->tab_grupo[0] .$nm_apl_dest . "/" . $nm_apl_dest . ".php";
      }
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
$contr_menu_neoenergia = new menu_neoenergia_class;
$contr_menu_neoenergia->menu_neoenergia_menu();
