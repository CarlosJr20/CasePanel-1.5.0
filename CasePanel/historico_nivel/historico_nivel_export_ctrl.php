<?php
@session_start() ;
$_SESSION['scriptcase']['historico_nivel']['sc_process_barr'] = true;
require_once('../historico_nivel/index.php');
unset($_SESSION['scriptcase']['historico_nivel']['sc_process_barr']);
$ExportCtrl = new historico_nivel_export_control;
$ExportCtrl->Export_barr();

class historico_nivel_export_control
{
