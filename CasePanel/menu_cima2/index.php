<?php
include_once('menu_cima2_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_cima2']['glo_nm_perfil']         = "host_oficial";
    $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_cima2']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_cima2']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_cima2_class
{
  var $Db;
 ...
 function menu_cima2_menu()
 {
    global $menu_cima2_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_cima2']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_cima2/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_cima2');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_cima2_erro.php");
}
include_once(dirname(__FILE__) . "/menu_cima2_erro.class.php"); 
$this->Erro = new menu_cima2_erro();
$str_path = substr($_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$menu_cima2_menuData         = array();
$menu_cima2_menuData['path'] = array();
$menu_cima2_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_cima2_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_cima2_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_cima2_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_cima2_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_cima2_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_cima2_menuData['url']['web']   = str_replace("\\", '/', $menu_cima2_menuData['url']['web']);
$menu_cima2_menuData['path']['root'] = substr($menu_cima2_menuData['path']['sys'],  0, -1 * strlen($menu_cima2_menuData['url']['web']));
$menu_cima2_menuData['path']['app']  = substr($menu_cima2_menuData['path']['sys'],  0, strrpos($menu_cima2_menuData['path']['sys'],  '/'));
$menu_cima2_menuData['path']['link'] = substr($menu_cima2_menuData['path']['app'],  0, strrpos($menu_cima2_menuData['path']['app'],  '/'));
$menu_cima2_menuData['path']['link'] = substr($menu_cima2_menuData['path']['link'], 0, strrpos($menu_cima2_menuData['path']['link'], '/')) . '/';
$menu_cima2_menuData['path']['app'] .= '/';
$menu_cima2_menuData['url']['app']   = substr($menu_cima2_menuData['url']['web'],  0, strrpos($menu_cima2_menuData['url']['web'],  '/'));
$menu_cima2_menuData['url']['link']  = substr($menu_cima2_menuData['url']['app'],  0, strrpos($menu_cima2_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] == "S")
{
    $menu_cima2_menuData['url']['link']  = substr($menu_cima2_menuData['url']['link'], 0, strrpos($menu_cima2_menuData['url']['link'], '/'));
}
$menu_cima2_menuData['url']['link']  .= '/';
$menu_cima2_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_cima2']['sc_apl_link'] = $menu_cima2_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_cima2']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_cima2']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_cima2']['actual_lang']) || $_SESSION['scriptcase']['menu_cima2']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_cima2']['actual_lang'] = $this->str_lang;
...
include_once("menu_cima2_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_cima2";
     $_SESSION['scriptcase']['menu_apls']['menu_cima2'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_cima2']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_cima2']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_cima2']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_cima2']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_cima2']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_cima2']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_cima2']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_cima2']['init']))
{
    $_SESSION['sc_session'][1]['menu_cima2']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_cima2']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_cima2'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_cima2'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_cima2'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_cima2'] = "on";
} 
if (!isset($_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_cima2']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_cima2'] != "on"))
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'], 'Web_Case_IoT_V_1_12', 2); 
}
if (isset($_SESSION['scriptcase']['menu_cima2']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_cima2']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_cima2']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_cima2']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_cima2']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_cima2']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_cima2']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_cima2']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_cima2']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu_cima2']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'], 'Web_Case_IoT_V_1_12'); 
} 
else 
{ 
...
//
      $_SESSION['scriptcase']['menu_cima2']['contr_erro'] = 'on';
...
{
    $_SESSION['scriptcase']['sc_menu_del']['menu_cima2'][] = trim($Cada_del);
}
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_cima2'))
{
    $_SESSION['sc_session'][1]['menu_cima2']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_cima2'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$menu_cima2_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("WEBCASEIoT") . "/WEBCASEIoT_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['WEBCASEIoT']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['WEBCASEIoT'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grafico_nivel_maior") . "/grafico_nivel_maior_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grafico_nivel_maior") . "/grafico_nivel_maior_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_nivel_maior']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grafico_nivel_maior'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grafico_volume_maior") . "/grafico_volume_maior_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grafico_volume_maior") . "/grafico_volume_maior_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_volume_maior']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grafico_volume_maior'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("tank_maior") . "/tank_maior_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("tank_maior") . "/tank_maior_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['tank_maior']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['tank_maior'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("historico_nivel") . "/historico_nivel_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("historico_nivel") . "/historico_nivel_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['historico_nivel'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("historico_volume") . "/historico_volume_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("historico_volume") . "/historico_volume_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['historico_volume'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_cima2'];
$menu_cima2_menuData['data'] .= "item_22|.|" . $nm_var_lab[0] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $menu_cima2_menuData['data'] .= "item_23|..|" . $this->Nm_lang['lang_list_users'] . "|menu_cima2_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_cima2_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}
...
{
    $menu_cima2_menuData['data'] .= "item_25|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_cima2_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}
...
{
    $menu_cima2_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|menu_cima2_form_php.php?sc_item_menu=item_32&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}
...
{
    $menu_cima2_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_cima2_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_cima2_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_30|..|" . $this->Nm_lang['lang_logged_users'] . "|menu_cima2_form_php.php?sc_item_menu=item_30&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_logged_users'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_cima2_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_29|..|" . $this->Nm_lang['lang_exit'] . "|menu_cima2_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_cima2_target('_parent') . "|" . "\n";
}

$menu_cima2_menuData['data'] .= "item_33|.|" . $nm_var_lab[1] . "||" . $nm_var_hint[0] . "||_self|\n";
$menu_cima2_menuData['data'] .= "item_11|..|" . $nm_var_lab[2] . "||" . $nm_var_hint[1] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_nivel_maior']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_nivel_maior']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_12|...|" . $nm_var_lab[3] . "|menu_cima2_form_php.php?sc_item_menu=item_12&sc_apl_menu=grafico_nivel_maior&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_volume_maior']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_volume_maior']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_16|...|" . $nm_var_lab[4] . "|menu_cima2_form_php.php?sc_item_menu=item_16&sc_apl_menu=grafico_volume_maior&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['tank_maior']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['tank_maior']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_21|...|" . $nm_var_lab[5] . "|menu_cima2_form_php.php?sc_item_menu=item_21&sc_apl_menu=tank_maior&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

$menu_cima2_menuData['data'] .= "item_35|..|" . $nm_var_lab[6] . "||" . $nm_var_hint[5] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_36|...|" . $nm_var_lab[7] . "|menu_cima2_form_php.php?sc_item_menu=item_36&sc_apl_menu=historico_nivel&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_37|...|" . $nm_var_lab[8] . "|menu_cima2_form_php.php?sc_item_menu=item_37&sc_apl_menu=historico_volume&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

$menu_cima2_menuData['data'] .= "item_4|.|" . $_SESSION['usr_name'] . "||" . $nm_var_hint[8] . "|scriptcase__NM__bg__NM__admin_proj.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_9|..|" . $nm_var_lab[9] . "|menu_cima2_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_cima2_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_cima2_menuData['data'] .= "item_6|..|" . $nm_var_lab[10] . "|menu_cima2_form_php.php?sc_item_menu=item_6&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_cima2_target('_parent') . "|" . "\n";
}


$menu_cima2_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
$str_icon = "";
$icon_aba = "";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_cima2_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_cima2_target('_self') . "\"",
        'sc_id'    => "item_23",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_32&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_30&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_cima2_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_cima2_target('_parent') . "\"",
        'sc_id'    => "item_29",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_12&sc_apl_menu=grafico_nivel_maior&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_nivel_maior']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_nivel_maior']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_16&sc_apl_menu=grafico_volume_maior&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_volume_maior']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_volume_maior']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_21&sc_apl_menu=tank_maior&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['tank_maior']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['tank_maior']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_36&sc_apl_menu=historico_nivel&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_37&sc_apl_menu=historico_volume&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_cima2_form_php.php?sc_item_menu=item_6&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_cima2']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_cima2']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_cima2');
    $menu_cima2_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_cima2_help.txt"))
{
    $Arq_WebHelp = file("menu_cima2_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_cima2_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_cima2_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_cima2']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_cima2']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_cima2_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_cima2']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_cima2_menuData['data'][$i_menu]);
       }
    ...
    $menu_cima2_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_cima2']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_cima2']))
{
    $disable_menu = false;
    foreach ($menu_cima2_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_cima2']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_cima2_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_cima2_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_cima2_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_cima2_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_cima2_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_cima2_menuData['data'][$chave]['level'];
                        unset($menu_cima2_menuData['data'][$chave]);
                }
        }
}
$menu_cima2_menuData['data'] = array_values($menu_cima2_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_cima2_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($menu_cima2_menuData['data'][$chave + 1]) && !empty($menu_cima2_menuData['data'][$chave + 1]))
            {
                if ($menu_cima2_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_cima2_menuData['data'][$chave]['level'] >= $menu_cima2_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_cima2_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_cima2_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_cima2_menuData['data'][$chave]);
            }
        }
...
/* Cabeçalho HTML */
if ($menu_cima2_menuData['iframe'])
{
    $menu_cima2_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<style>
   ...
   #item_21 .icon_fa{ color: #3094db  !important}
   #aba_td_item_21 i{ color:#3094db  !important}
   #item_21:hover .icon_fa{ color: #d2dae2  !important}
   #aba_td_item_21:hover i{ color:#d2dae2  !important}
   #item_21.scdisabledmain .icon_fa{ color: #d2dae2  !important}
   #item_21.scdisabledsub .icon_fa{ color: #d2dae2  !important}
   #aba_td_item_21.scTabInactive i{ color:#d2dae2  !important}
...
{
    $menu_cima2_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_cima2_message.js"></script>
...
Iframe_atual = "menu_cima2_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_cima2\";\r\n";
echo "Tab_labels['menu_cima2'] = \"  Home\";\r\n";
echo "Tab_hints['menu_cima2'] = \"  Home\";\r\n";
echo "Tab_abas['menu_cima2']   = \"none\";\r\n";
echo "Tab_refresh['menu_cima2']   = \"\";\r\n";
echo "Tab_icons['menu_cima2'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_cima2'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_cima2']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_cima2']   = \"\";\r\n";
echo "Tab_display['menu_cima2']   = \"\";\r\n";
echo "Tab_display_position['menu_cima2']   = \"\";\r\n";
echo "Tab_links['menu_cima2']   = \"\";\r\n";
         $seq++;
 if(isset($menu_cima2_menuData['data']) && !empty($menu_cima2_menuData['data']))
 {
   foreach ($menu_cima2_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_cima2_menuData['data_vertical']) && !empty($menu_cima2_menuData['data_vertical']))
 {
   foreach ($menu_cima2_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_cima2_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_cima2'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_cima2').hide();
    if (str_id == "")
    {
        $('#iframe_menu_cima2').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            if (Tab_iframes[i] != 'menu_cima2') 
            {
                Iframe_atual = "menu_cima2_" + Tab_iframes[i] + '_iframe';
            }
...
{
    if(str_id === 'menu_cima2') { return false; }
    ...
    if (Aba_atual == str_id)
    {
        ...
        if (str_id == "" && Aba_atual != "menu_cima2")
        {
            document.getElementById('iframe_menu_cima2').click();
        }
        else
        {
            mudaIframe(str_id);
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_cima2")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_cima2_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_cima2', 'menu_cima2');
    if (str_target == "menu_cima2_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
    ...
    if(str_target != '_blank' && $('#iframe_menu_cima2').length)
        $('#iframe_menu_cima2')[0].contentWindow.focus();
  }
}
</script>
...
echo $this->menu_cima2_escreveMenu($menu_cima2_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_cima2_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['WEBCASEIoT']) && $_SESSION['scriptcase']['sc_apl_seg']['WEBCASEIoT'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_cima2');\" item-href=\"menu_cima2_form_php.php?sc_item_menu=menu_cima2&sc_apl_menu=WEBCASEIoT&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_cima2_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_cima2_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_cima2" name="menu_cima2_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
 foreach ($menu_cima2_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_cima2_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_cima2').click()";
    echo "</script>";
}
...
/* Controle de Target */
function menu_cima2_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('menu_cima2_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
...
function menu_cima2_target($str_target)
{
    global $menu_cima2_menuData;
    ...
    elseif ($menu_cima2_menuData['iframe'])
    {
        return 'menu_cima2_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_cima2_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_cima2_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_cima2_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_cima2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cima2']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_cima2_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_cima2']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_cima2']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_cima2']['sc_init'][$apl_menu];
   }
...
;
 ...
 {
$this->nmgp_redireciona_form($_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('app_logged') . "/", "menu_cima2_form_php.php", "user?#?" . NM_encode_input($user) . "?@?","_self", 440, 630);
 };
			return false;
		}
$_SESSION['scriptcase']['menu_cima2']['contr_erro'] = 'off';
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('app_Login') . "/", "menu_cima2_form_php.php", "","_parent", 440, 630);
 };
		}
if (isset($this->sc_temp_logged_user)) {$_SESSION['logged_user'] = $this->sc_temp_logged_user;}
if (isset($this->sc_temp_logged_date_login)) {$_SESSION['logged_date_login'] = $this->sc_temp_logged_date_login;}
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0)
   {
      ...
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][1]['menu_cima2'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      {
          $nm_apl_dest = str_replace(".php", "", $nm_apl_dest);
          $nm_apl_dest = $menu_cima2_menuData['url']['link'] . $this->tab_grupo[0] .$nm_apl_dest . "/" . $nm_apl_dest . ".php";
      }
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_cima2']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_cima2") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_cima2']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'])) {
            $_SESSION['scriptcase']['menu_cima2']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'];
        }
    }
}
...
$contr_menu_cima2 = new menu_cima2_class;
$contr_menu_cima2->menu_cima2_menu();
