...
<html>
    <head>
        ...
        <title>{lang_v94_menu_content_title}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_cima2"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Dark_nit/Dark_nit_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Dark_nit/Dark_nit_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_cima2"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_cima2"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_cima2_menuData["data"]) && is_array($menu_cima2_menuData["data"]) && !empty($menu_cima2_menuData["data"]))
    {
        foreach($menu_cima2_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($menu_cima2_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
