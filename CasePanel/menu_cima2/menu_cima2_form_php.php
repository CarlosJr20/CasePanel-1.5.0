...
class menu_cima2_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_cima2']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['menu_cima2']['sc_apl_link'];
...
if ($this->Db)
{
    $this->Db->Close(); 
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "menu_cima2")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("WEBCASEIoT") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['menu_cima2']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_cima2'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_grid_sec_users") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_24")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_grid_sec_apps") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_25")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_grid_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_32")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_grid_sec_users_groups") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_26")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_search_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_27")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_sync_apps") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_30")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_logged_users") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_28")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_change_pswd") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_29")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_Login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['menu_cima2']['init'] . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_12")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grafico_nivel_maior") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_16")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grafico_volume_maior") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_21")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("tank_maior") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_36")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("historico_nivel") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_37")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("historico_volume") . "/?nm_run_menu=1&nm_apl_menu=menu_cima2&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_cima2"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_cima2")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_cima2', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['menu_cima2']['sc_init'][$apl_menu];
...
$controle = new menu_cima2_form_php();
$controle->init();
?>
