<?php
@session_start() ;
$_SESSION['scriptcase']['chart_fonte_nivel']['sc_process_barr'] = true;
require_once('../chart_fonte_nivel/index.php');
unset($_SESSION['scriptcase']['chart_fonte_nivel']['sc_process_barr']);
$ExportCtrl = new chart_fonte_nivel_export_control;
$ExportCtrl->Export_barr();

class chart_fonte_nivel_export_control
{
