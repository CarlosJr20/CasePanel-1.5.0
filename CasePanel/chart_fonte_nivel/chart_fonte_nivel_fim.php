...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____chart_fonte_nivel"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____chart_fonte_nivel"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fonte_nivel']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_fonte_nivel']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fonte_nivel']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_fonte_nivel']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_fonte_nivel']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_fonte_nivel']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_fonte_nivel']['embutida_filho'] as $ind => $sc_init)
          {
