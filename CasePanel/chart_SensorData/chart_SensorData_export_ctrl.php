<?php
@session_start() ;
$_SESSION['scriptcase']['chart_SensorData']['sc_process_barr'] = true;
require_once('../chart_SensorData/index.php');
unset($_SESSION['scriptcase']['chart_SensorData']['sc_process_barr']);
$ExportCtrl = new chart_SensorData_export_control;
$ExportCtrl->Export_barr();

class chart_SensorData_export_control
{
