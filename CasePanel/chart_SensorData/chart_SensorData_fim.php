...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____chart_SensorData"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____chart_SensorData"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_SensorData']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_SensorData']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_SensorData']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_SensorData']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_SensorData']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_SensorData']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_SensorData']['embutida_filho'] as $ind => $sc_init)
          {
