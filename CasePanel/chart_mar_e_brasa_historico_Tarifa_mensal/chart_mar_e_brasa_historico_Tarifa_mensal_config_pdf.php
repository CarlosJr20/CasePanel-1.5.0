...
*/
    ...
    $SC_cod_proj = "Web_Case_IoT_V_1_12";
    $SC_apl_proc = "chart_mar_e_brasa_historico_Tarifa_mensal";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['chart_mar_e_brasa_historico_Tarifa_mensal']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['chart_mar_e_brasa_historico_Tarifa_mensal']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['chart_mar_e_brasa_historico_Tarifa_mensal']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['chart_mar_e_brasa_historico_Tarifa_mensal']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['chart_mar_e_brasa_historico_Tarifa_mensal']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['chart_mar_e_brasa_historico_Tarifa_mensal']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['chart_mar_e_brasa_historico_Tarifa_mensal']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['chart_mar_e_brasa_historico_Tarifa_mensal']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['chart_mar_e_brasa_historico_Tarifa_mensal']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['chart_mar_e_brasa_historico_Tarifa_mensal']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
