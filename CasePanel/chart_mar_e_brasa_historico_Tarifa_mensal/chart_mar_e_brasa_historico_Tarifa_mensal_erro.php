...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['chart_mar_e_brasa_historico_Tarifa_mensal']['contr_erro']) && $_SESSION['scriptcase']['chart_mar_e_brasa_historico_Tarifa_mensal']['contr_erro'] == 'on')
    {
