<?php
@session_start() ;
$_SESSION['scriptcase']['chart_mar_e_brasa_historico_Tarifa_mensal']['sc_process_barr'] = true;
require_once('../chart_mar_e_brasa_historico_Tarifa_mensal/index.php');
unset($_SESSION['scriptcase']['chart_mar_e_brasa_historico_Tarifa_mensal']['sc_process_barr']);
$ExportCtrl = new chart_mar_e_brasa_historico_Tarifa_mensal_export_control;
$ExportCtrl->Export_barr();

class chart_mar_e_brasa_historico_Tarifa_mensal_export_control
{
