<?php
include_once('nav_bar_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['nav_bar']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['nav_bar']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['nav_bar']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['nav_bar']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
...
class nav_bar_class
{
 ...
 {
    global $nav_bar_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['nav_bar']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "nav_bar/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['nav_bar']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('nav_bar');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/nav_bar_erro.php");
}
include_once(dirname(__FILE__) . "/nav_bar_erro.class.php"); 
$this->Erro = new nav_bar_erro();
$str_path = substr($_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['nav_bar']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$nav_bar_menuData         = array();
$nav_bar_menuData['path'] = array();
$nav_bar_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $nav_bar_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $nav_bar_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $nav_bar_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $nav_bar_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$nav_bar_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$nav_bar_menuData['url']['web']   = str_replace("\\", '/', $nav_bar_menuData['url']['web']);
$nav_bar_menuData['path']['root'] = substr($nav_bar_menuData['path']['sys'],  0, -1 * strlen($nav_bar_menuData['url']['web']));
$nav_bar_menuData['path']['app']  = substr($nav_bar_menuData['path']['sys'],  0, strrpos($nav_bar_menuData['path']['sys'],  '/'));
$nav_bar_menuData['path']['link'] = substr($nav_bar_menuData['path']['app'],  0, strrpos($nav_bar_menuData['path']['app'],  '/'));
$nav_bar_menuData['path']['link'] = substr($nav_bar_menuData['path']['link'], 0, strrpos($nav_bar_menuData['path']['link'], '/')) . '/';
$nav_bar_menuData['path']['app'] .= '/';
$nav_bar_menuData['url']['app']   = substr($nav_bar_menuData['url']['web'],  0, strrpos($nav_bar_menuData['url']['web'],  '/'));
$nav_bar_menuData['url']['link']  = substr($nav_bar_menuData['url']['app'],  0, strrpos($nav_bar_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] == "S")
{
    $nav_bar_menuData['url']['link']  = substr($nav_bar_menuData['url']['link'], 0, strrpos($nav_bar_menuData['url']['link'], '/'));
}
$nav_bar_menuData['url']['link']  .= '/';
$nav_bar_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['nav_bar']['sc_apl_link'] = $nav_bar_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['nav_bar']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['nav_bar']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['nav_bar']['actual_lang']) || $_SESSION['scriptcase']['nav_bar']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['nav_bar']['actual_lang'] = $this->str_lang;
...
include_once("nav_bar_toolbar.php");
...
if ($_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "nav_bar";
     $_SESSION['scriptcase']['menu_apls']['nav_bar'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['nav_bar']['glo_nm_conexao']) && $_SESSION['scriptcase']['nav_bar']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['nav_bar']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['nav_bar']['glo_nm_perfil']) && $_SESSION['scriptcase']['nav_bar']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['nav_bar']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['nav_bar']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['nav_bar']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['nav_bar']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['nav_bar']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['nav_bar']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['nav_bar']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['nav_bar']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['nav_bar']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['nav_bar']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['nav_bar']['init']))
{
    $_SESSION['sc_session'][1]['nav_bar']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['nav_bar']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['nav_bar']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_nav_bar'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_nav_bar'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_nav_bar'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['nav_bar'] = "on";
} 
if (!isset($_SESSION['scriptcase']['nav_bar']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['nav_bar']) || $_SESSION['scriptcase']['sc_apl_seg']['nav_bar'] != "on"))
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'nav_bar'))
{
    $_SESSION['sc_session'][1]['nav_bar']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_nav_bar'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$nav_bar_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("sc94_menu_font_awesome_w_toolbar_content") . "/sc94_menu_font_awesome_w_toolbar_content_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sc94_menu_font_awesome_w_toolbar_content']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['sc94_menu_font_awesome_w_toolbar_content'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
/* Itens do Menu */
$_SESSION['scriptcase']['nav_bar']['contr_erro'] = 'on';
 ?><style>
	.scTabLine{background-color: #fff!important;}
	#idMenuLine{display: none !important; }
</style><?php
$_SESSION['scriptcase']['nav_bar']['contr_erro'] = 'off';
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_nav_bar'];
$nav_bar_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";

$nav_bar_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
$str_icon = "";
$icon_aba = "";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['nav_bar']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['nav_bar']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'nav_bar');
    $nav_bar_menuData['data'] = $str_menu_usu;
}
if (is_file("nav_bar_help.txt"))
{
    $Arq_WebHelp = file("nav_bar_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $nav_bar_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->nav_bar_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['nav_bar']) && !empty($_SESSION['scriptcase']['sc_menu_del']['nav_bar']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($nav_bar_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['nav_bar']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($nav_bar_menuData['data'][$i_menu]);
       }
    ...
    $nav_bar_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['nav_bar']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['nav_bar']))
{
    $disable_menu = false;
    foreach ($nav_bar_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['nav_bar']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $nav_bar_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
{
    $_SESSION['scriptcase']['menu_mobile'] = "nav_bar";
    include('nav_bar_mobile.php');
    exit;
}
/* Cabeçalho HTML */
if ($nav_bar_menuData['iframe'])
{
    $nav_bar_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/grp_Elegant_Project_Manage_Black_hor_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "grp_Elegant_Project_Manage_Black" . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "grp_Elegant_Project_Manage_Black" . '_' . hor . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
{
    $nav_bar_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="nav_bar_message.js"></script>
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"nav_bar\";\r\n";
echo "Tab_labels['nav_bar'] = \"Home\";\r\n";
echo "Tab_hints['nav_bar'] = \"Home\";\r\n";
echo "Tab_abas['nav_bar']   = \"none\";\r\n";
echo "Tab_refresh['nav_bar']   = \"\";\r\n";
echo "Tab_icons['nav_bar'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['nav_bar'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['nav_bar']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['nav_bar']   = \"\";\r\n";
echo "Tab_display['nav_bar']   = \"\";\r\n";
echo "Tab_display_position['nav_bar']   = \"\";\r\n";
echo "Tab_links['nav_bar']   = \"\";\r\n";
         $seq++;
 if(isset($nav_bar_menuData['data']) && !empty($nav_bar_menuData['data']))
 {
   foreach ($nav_bar_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($nav_bar_menuData['data_vertical']) && !empty($nav_bar_menuData['data_vertical']))
 {
   foreach ($nav_bar_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint))
{
 ...
 echo "Tab_icons['btn_2'] = \"\";\r\n";
 echo "Tab_icons_inactive['btn_2'] = \"\";\r\n";
 echo "Tab_abas['btn_2']   = \"none\";\r\n";
 echo "Tab_icon_fa['btn_2'] = \"fas fa-user-circle\";\r\n";
 echo "Tab_icon_fa_inactive['btn_2'] = \"fas fa-user-circle\";\r\n";
 echo "Tab_display['btn_2'] = \"text_fontawesomeicon\";\r\n";
 echo "Tab_display_position['btn_2'] = \"text_right\";\r\n";
 $seq++;
$nm_var_lab = "Personal Data";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab))
{
    $nm_var_lab = sc_convert_encoding($nm_var_lab, $_SESSION['scriptcase']['charset'], "UTF-8");
}
$nm_var_hint = "Personal Data";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint))
{
    $nm_var_hint = sc_convert_encoding($nm_var_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
}
 echo "Tab_iframes[" . $seq . "] = \"btn_8\";\r\n";
 echo "Tab_labels['btn_8'] = \"". html_entity_decode(sc_htmlentities($nm_var_lab)) . "\";\r\n";
 echo "Tab_hints['btn_8'] = \"" . strip_tags(sc_htmlentities($nm_var_hint)) . "\";\r\n";
 echo "Tab_icons['btn_8'] = \"\";\r\n";
 echo "Tab_icons_inactive['btn_8'] = \"\";\r\n";
 echo "Tab_abas['btn_8']   = \"none\";\r\n";
 echo "Tab_icon_fa['btn_8'] = \"fas fa-info-circle\";\r\n";
 echo "Tab_icon_fa_inactive['btn_8'] = \"fas fa-info-circle\";\r\n";
 echo "Tab_display['btn_8'] = \"text_fontawesomeicon\";\r\n";
 echo "Tab_display_position['btn_8'] = \"text_right\";\r\n";
 $seq++;
$nm_var_lab = "Change Password";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab))
{
    $nm_var_lab = sc_convert_encoding($nm_var_lab, $_SESSION['scriptcase']['charset'], "UTF-8");
}
$nm_var_hint = "Change Password";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint))
{
    $nm_var_hint = sc_convert_encoding($nm_var_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
}
 echo "Tab_iframes[" . $seq . "] = \"btn_9\";\r\n";
 echo "Tab_labels['btn_9'] = \"". html_entity_decode(sc_htmlentities($nm_var_lab)) . "\";\r\n";
 echo "Tab_hints['btn_9'] = \"" . strip_tags(sc_htmlentities($nm_var_hint)) . "\";\r\n";
 echo "Tab_icons['btn_9'] = \"\";\r\n";
 echo "Tab_icons_inactive['btn_9'] = \"\";\r\n";
 echo "Tab_abas['btn_9']   = \"none\";\r\n";
 echo "Tab_icon_fa['btn_9'] = \"fas fa-key\";\r\n";
 echo "Tab_icon_fa_inactive['btn_9'] = \"fas fa-key\";\r\n";
 echo "Tab_display['btn_9'] = \"text_fontawesomeicon\";\r\n";
 echo "Tab_display_position['btn_9'] = \"text_right\";\r\n";
 $seq++;
$nm_var_lab = "Settings";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab))
{
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint))
{
 ...
 echo "Tab_icons['btn_1'] = \"\";\r\n";
 echo "Tab_icons_inactive['btn_1'] = \"\";\r\n";
 echo "Tab_abas['btn_1']   = \"none\";\r\n";
 echo "Tab_icon_fa['btn_1'] = \"fas fa-cogs\";\r\n";
 echo "Tab_icon_fa_inactive['btn_1'] = \"fas fa-cogs\";\r\n";
 echo "Tab_display['btn_1'] = \"text_fontawesomeicon\";\r\n";
 echo "Tab_display_position['btn_1'] = \"text_right\";\r\n";
 $seq++;
$nm_var_lab = "Generate Log";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab))
{
    $nm_var_lab = sc_convert_encoding($nm_var_lab, $_SESSION['scriptcase']['charset'], "UTF-8");
}
$nm_var_hint = "Generate Log";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint))
{
    $nm_var_hint = sc_convert_encoding($nm_var_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
}
 echo "Tab_iframes[" . $seq . "] = \"btn_10\";\r\n";
 echo "Tab_labels['btn_10'] = \"". html_entity_decode(sc_htmlentities($nm_var_lab)) . "\";\r\n";
 echo "Tab_hints['btn_10'] = \"" . strip_tags(sc_htmlentities($nm_var_hint)) . "\";\r\n";
 echo "Tab_icons['btn_10'] = \"\";\r\n";
 echo "Tab_icons_inactive['btn_10'] = \"\";\r\n";
 echo "Tab_abas['btn_10']   = \"none\";\r\n";
 echo "Tab_icon_fa['btn_10'] = \"far fa-file\";\r\n";
 echo "Tab_icon_fa_inactive['btn_10'] = \"far fa-file\";\r\n";
 echo "Tab_display['btn_10'] = \"text_fontawesomeicon\";\r\n";
 echo "Tab_display_position['btn_10'] = \"text_right\";\r\n";
 $seq++;
$nm_var_lab = "Preferences";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab))
{
    $nm_var_lab = sc_convert_encoding($nm_var_lab, $_SESSION['scriptcase']['charset'], "UTF-8");
}
$nm_var_hint = "Preferences";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint))
{
    $nm_var_hint = sc_convert_encoding($nm_var_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
}
 echo "Tab_iframes[" . $seq . "] = \"btn_11\";\r\n";
 echo "Tab_labels['btn_11'] = \"". html_entity_decode(sc_htmlentities($nm_var_lab)) . "\";\r\n";
 echo "Tab_hints['btn_11'] = \"" . strip_tags(sc_htmlentities($nm_var_hint)) . "\";\r\n";
 echo "Tab_icons['btn_11'] = \"\";\r\n";
 echo "Tab_icons_inactive['btn_11'] = \"\";\r\n";
 echo "Tab_abas['btn_11']   = \"none\";\r\n";
 echo "Tab_icon_fa['btn_11'] = \"fas fa-sliders-h\";\r\n";
 echo "Tab_icon_fa_inactive['btn_11'] = \"fas fa-sliders-h\";\r\n";
 echo "Tab_display['btn_11'] = \"text_fontawesomeicon\";\r\n";
 echo "Tab_display_position['btn_11'] = \"text_right\";\r\n";
 $seq++;
?>
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'nav_bar_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'nav_bar'){ home_style=";padding-left:4px;min-height:14px;"; }
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            if (Tab_iframes[i] != 'nav_bar') 
            {
                Iframe_atual = "nav_bar_" + Tab_iframes[i] + '_iframe';
            }
...
{
    if(str_id === 'nav_bar') { return false; }
    ...
    if (Aba_atual == str_id)
    {
        ...
        if (str_id == "" && Aba_atual != "nav_bar")
        {
            document.getElementById('iframe_nav_bar').click();
        }
        else
        {
            mudaIframe(str_id);
...
function mudaIframe_btn()
{
    ...
    $('#iframe_nav_bar').css('display','');
    $('#iframe_nav_bar')[0].contentWindow.focus();
}
...
{
  str_target_sv = "";
  if (str_id != "iframe_nav_bar")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("nav_bar_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_nav_bar', 'nav_bar');
    if (str_target == "nav_bar_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
    ...
    if(str_target != '_blank' && $('#iframe_nav_bar').length)
        $('#iframe_nav_bar')[0].contentWindow.focus();
  }
}
</script>
...
echo $this->nav_bar_escreveMenu($nav_bar_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $nav_bar_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sc94_menu_font_awesome_w_toolbar_content']) && $_SESSION['scriptcase']['sc_apl_seg']['sc94_menu_font_awesome_w_toolbar_content'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_nav_bar');\" item-href=\"nav_bar_form_php.php?sc_item_menu=nav_bar&sc_apl_menu=sc94_menu_font_awesome_w_toolbar_content&sc_apl_link=" . urlencode($nav_bar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] . "\"  item-target=\"nav_bar_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "nav_bar_pag_ini.php");
} 
?>
      <iframe id="iframe_nav_bar" name="nav_bar_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
 foreach ($nav_bar_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"nav_bar_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
     echo "      <iframe id=\"iframe_btn_2\" name=\"nav_bar_btn_2_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;\" src=\"\"></iframe>
";
     echo "      <iframe id=\"iframe_btn_8\" name=\"nav_bar_btn_8_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;\" src=\"\"></iframe>
";
     echo "      <iframe id=\"iframe_btn_9\" name=\"nav_bar_btn_9_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;\" src=\"\"></iframe>
";
     echo "      <iframe id=\"iframe_btn_1\" name=\"nav_bar_btn_1_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;\" src=\"\"></iframe>
";
     echo "      <iframe id=\"iframe_btn_10\" name=\"nav_bar_btn_10_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;\" src=\"\"></iframe>
";
     echo "      <iframe id=\"iframe_btn_11\" name=\"nav_bar_btn_11_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;\" src=\"\"></iframe>
";
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_nav_bar').click()";
    echo "</script>";
}
...
/* Controle de Target */
function nav_bar_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
?>
        <td class='sc-layer-1' style='width:0.2%;text-align:left;'>
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('nav_bar_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
...
function nav_bar_target($str_target)
{
    global $nav_bar_menuData;
    ...
    elseif ($nav_bar_menuData['iframe'])
    {
        return 'nav_bar_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $nav_bar_menuData, $path_imag_cab)
{
    ?>
    <tr id="id_toolbar">
        <td class="scMenuHTableCss" align="left" style="margin:0px; padding:0px;" <?php echo $col_span; ?>>
            ...
            <?php
                ...
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_2", "javascript:", "javascript:", "btn_2", "", "My Profile", "", "absmiddle", "", "0px", $this->path_botoes, "", "", "", "", "__sc_grp__", "text_fontawesomeicon", "text_right", "1", "" . $this->nav_bar_target('_self') . "", "", "", "1", "nav_bar", "");
                    ?>
                            ...
                            <td class="scBtnGrpBackground">
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "nav_bar_form_php.php?sc_item_menu=btn_8&sc_apl_menu=sc94_menu_font_awesome_w_toolbar_content&sc_apl_link=". urlencode($nav_bar_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_8']['disabled']) && strtolower($this->arr_buttons['btn_8']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_8" item-href="<?php echo $str_href; ?>" href='#' onclick="openMenuItem('nav_bar_btn_8');" class="scBtnGrpLink" title="" item-target="<?php echo $this->nav_bar_target('_self'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-info-circle'></i> Personal Data</a>
                                  </div>
                              <?php
                              }
                              ?>
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "nav_bar_form_php.php?sc_item_menu=btn_9&sc_apl_menu=sc94_menu_font_awesome_w_toolbar_content&sc_apl_link=". urlencode($nav_bar_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_9']['disabled']) && strtolower($this->arr_buttons['btn_9']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_9" item-href="<?php echo $str_href; ?>" href='#' onclick="openMenuItem('nav_bar_btn_9');" class="scBtnGrpLink" title="" item-target="<?php echo $this->nav_bar_target('_self'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-key'></i> Change Password</a>
                                  </div>
                              <?php
                              }
                              ?>
                ...
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_1", "javascript:", "javascript:", "btn_1", "", "Settings", "", "absmiddle", "", "0px", $this->path_botoes, "", "", "", "", "__sc_grp__", "text_fontawesomeicon", "text_right", "1", "" . $this->nav_bar_target('_self') . "", "", "", "1", "nav_bar", "");
                    ?>
                        ...
                        <tr>
                            <td class="scBtnGrpBackground">
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "nav_bar_form_php.php?sc_item_menu=btn_10&sc_apl_menu=sc94_menu_font_awesome_w_toolbar_content&sc_apl_link=". urlencode($nav_bar_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_10']['disabled']) && strtolower($this->arr_buttons['btn_10']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_10" item-href="<?php echo $str_href; ?>" href='#' onclick="openMenuItem('nav_bar_btn_10');" class="scBtnGrpLink" title="" item-target="<?php echo $this->nav_bar_target('_self'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa far fa-file'></i> Generate Log</a>
                                  </div>
                              <?php
                              }
                              ?>
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "nav_bar_form_php.php?sc_item_menu=btn_11&sc_apl_menu=sc94_menu_font_awesome_w_toolbar_content&sc_apl_link=". urlencode($nav_bar_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_11']['disabled']) && strtolower($this->arr_buttons['btn_11']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_11" item-href="<?php echo $str_href; ?>" href='#' onclick="openMenuItem('nav_bar_btn_11');" class="scBtnGrpLink" title="" item-target="<?php echo $this->nav_bar_target('_self'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-sliders-h'></i> Preferences</a>
                                  </div>
                              <?php
                              }
                              ?>
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "nav_bar_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($nav_bar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "nav_bar_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($nav_bar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['nav_bar']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->nav_bar_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['nav_bar']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['nav_bar']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['nav_bar']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['nav_bar']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['nav_bar']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "nav_bar") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['nav_bar']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['nav_bar']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['nav_bar']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'])) {
            $_SESSION['scriptcase']['nav_bar']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'];
        }
    }
}
...
$contr_nav_bar = new nav_bar_class;
$contr_nav_bar->nav_bar_menu();
