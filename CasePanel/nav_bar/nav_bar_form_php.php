...
class nav_bar_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['nav_bar']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['nav_bar']['sc_apl_link'];
...
<?php
    exit;
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "nav_bar")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sc94_menu_font_awesome_w_toolbar_content") . "/?nm_run_menu=1&nm_apl_menu=nav_bar&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['nav_bar']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['nav_bar'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sc94_menu_font_awesome_w_toolbar_content") . "/?nm_run_menu=1&nm_apl_menu=nav_bar&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="nav_bar"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "nav_bar")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'nav_bar', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['nav_bar']['sc_init'][$apl_menu];
