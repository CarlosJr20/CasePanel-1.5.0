...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["nav_bar"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["nav_bar"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["nav_bar"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($nav_bar_menuData["data"]) && is_array($nav_bar_menuData["data"]) && !empty($nav_bar_menuData["data"]))
    {
        foreach($nav_bar_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($nav_bar_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
