  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_login_oficial" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate links
  function do_ajax_login_oficial_validate_links()
  {
    var nomeCampo_links = "links";
    var var_links = scAjaxGetFieldText(nomeCampo_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_oficial_validate_links(var_links, var_script_case_init, do_ajax_login_oficial_validate_links_cb);
  } // do_ajax_login_oficial_validate_links

  function do_ajax_login_oficial_validate_links_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_oficial_validate_links_cb

  // ---------- Validate login
  function do_ajax_login_oficial_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_oficial_validate_login(var_login, var_script_case_init, do_ajax_login_oficial_validate_login_cb);
  } // do_ajax_login_oficial_validate_login

  function do_ajax_login_oficial_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_oficial_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_login_oficial_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_oficial_validate_pswd(var_pswd, var_script_case_init, do_ajax_login_oficial_validate_pswd_cb);
  } // do_ajax_login_oficial_validate_pswd

  function do_ajax_login_oficial_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_oficial_validate_pswd_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_login_oficial_submit_form()
  {
    scAjaxHideMessage();
    ...
    x_ajax_login_oficial_submit_form(var_links, var_login, var_pswd, var_links_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_login_oficial_submit_form_cb);
  } // do_ajax_login_oficial_submit_form

  function do_ajax_login_oficial_submit_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_login_oficial_submit_form_cb_after_alert);
  } // do_ajax_login_oficial_submit_form_cb
  function do_ajax_login_oficial_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_login_oficial_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_login_oficial_navigate_form()
  {
    perform_ajax_login_oficial_navigate_form();
  }

  function perform_ajax_login_oficial_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_login_oficial_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_login_oficial_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_login_oficial_navigate_form_cb_after_alert);
  } // do_ajax_login_oficial_navigate_form_cb
  function do_ajax_login_oficial_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_login_oficial_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_login_oficial_navigate_form_cb_after_alert
  function sc_hide_login_oficial_form()
  {
