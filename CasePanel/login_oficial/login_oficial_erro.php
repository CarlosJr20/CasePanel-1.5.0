...
$old_error_handler = set_error_handler("login_oficial_scriptcase_error_handler");

function login_oficial_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['login_oficial']['contr_erro']) && $_SESSION['scriptcase']['login_oficial']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_login_oficial->contr_login_oficial->Apl_com_erro = true;
            if ($inicial_login_oficial->contr_login_oficial->NM_ajax_flag)
            {
                $inicial_login_oficial->contr_login_oficial->NM_ajax_info['errList']['geral_login_oficial'][] = $msg;
                return;
            }
            login_oficial_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function login_oficial_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['login_oficial'])  && '' != $_SESSION['scriptcase']['error_icon']['login_oficial'])  ? $_SESSION['scriptcase']['error_icon']['login_oficial']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['login_oficial']) && '' != $_SESSION['scriptcase']['error_span_title']['login_oficial']) ? $_SESSION['scriptcase']['error_span_title']['login_oficial'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['login_oficial']) && '' != $_SESSION['scriptcase']['error_icon_title']['login_oficial']) ? $_SESSION['scriptcase']['error_icon_title']['login_oficial'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['login_oficial']['error_buffer'] .= ob_get_flush();
}
