...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>login_oficial/login_oficial_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['login_oficial'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['login_oficial'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['empty_filter'] = true;
       }
  }
?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("login_oficial");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("login_oficial");
 parent.scAjaxDetailHeight("login_oficial", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['login_oficial']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
