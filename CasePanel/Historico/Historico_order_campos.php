...
<?php
   ...
   $Ord_Cmp = new Historico_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Historico_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Historico']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['Historico']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['Historico']['labels']["data"] : "Data";
   $tab_ger_campos['hora'] = "on";
   $tab_def_campos['hora'] = "hora";
   $tab_labels["hora"]   = (isset($_SESSION['sc_session'][$sc_init]['Historico']['labels']["hora"])) ? $_SESSION['sc_session'][$sc_init]['Historico']['labels']["hora"] : "Hora";
   $tab_ger_campos['nivel_1'] = "on";
   $tab_def_campos['nivel_1'] = "nivel_1";
   $tab_labels["nivel_1"]   = (isset($_SESSION['sc_session'][$sc_init]['Historico']['labels']["nivel_1"])) ? $_SESSION['sc_session'][$sc_init]['Historico']['labels']["nivel_1"] : "Nivel 1";
   $tab_ger_campos['volume_1'] = "on";
   $tab_def_campos['volume_1'] = "volume_1";
   $tab_labels["volume_1"]   = (isset($_SESSION['sc_session'][$sc_init]['Historico']['labels']["volume_1"])) ? $_SESSION['sc_session'][$sc_init]['Historico']['labels']["volume_1"] : "Volume 1";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Historico']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Historico']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Historico']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Historico']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Historico']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Historico']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['Historico']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['Historico']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['Historico']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Historico_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Historico']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Historico']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
