...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "data";$Nm_datas[] = "data";$Nm_datas[] = "hora";$Nm_datas[] = "hora";$Nm_numeric[] = "id";$Nm_numeric[] = "nivel_1";$Nm_numeric[] = "nivel_2";$Nm_numeric[] = "nivel_3";$Nm_numeric[] = "volume_1";$Nm_numeric[] = "volume_2";$Nm_numeric[] = "volume_3";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nivel_1_cond" name="nivel_1_cond" onChange="nm_campos_between(document.getElementById('id_vis_nivel_1'), this, 'nivel_1')">
