<?php
@session_start() ;
$_SESSION['scriptcase']['Historico']['sc_process_barr'] = true;
require_once('../Historico/index.php');
unset($_SESSION['scriptcase']['Historico']['sc_process_barr']);
$ExportCtrl = new Historico_export_control;
$ExportCtrl->Export_barr();

class Historico_export_control
{
