...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menus_mar_e_brasa"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menus_mar_e_brasa"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menus_mar_e_brasa"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menus_mar_e_brasa_menuData["data"]) && is_array($menus_mar_e_brasa_menuData["data"]) && !empty($menus_mar_e_brasa_menuData["data"]))
    {
        foreach($menus_mar_e_brasa_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($menus_mar_e_brasa_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
