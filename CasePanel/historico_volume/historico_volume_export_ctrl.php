<?php
@session_start() ;
$_SESSION['scriptcase']['historico_volume']['sc_process_barr'] = true;
require_once('../historico_volume/index.php');
unset($_SESSION['scriptcase']['historico_volume']['sc_process_barr']);
$ExportCtrl = new historico_volume_export_control;
$ExportCtrl->Export_barr();

class historico_volume_export_control
{
