...
class historico_volume_lookup
{
   function lookup_res_data_SC_1()
   {
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['historico_volume']['where_res_lookup']))
       {
           $nm_comando .= " " .  $_SESSION['sc_session'][$this->Ini->sc_page]['historico_volume']['where_res_lookup'];
       }
