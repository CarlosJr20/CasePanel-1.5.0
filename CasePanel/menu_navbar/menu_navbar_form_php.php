...
class menu_navbar_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['menu_navbar']['sc_apl_link'];
...
<?php
    exit;
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "menu_navbar")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu_cima") . "/?nm_run_menu=1&nm_apl_menu=menu_navbar&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['menu_navbar']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_navbar'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu_cima") . "/?nm_run_menu=1&nm_apl_menu=menu_navbar&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_navbar"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_navbar")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_navbar', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new menu_navbar_form_php();
$controle->init();
?>
