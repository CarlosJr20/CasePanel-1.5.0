<?php
include_once('menu_navbar_session.php');
...
$_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['menu_navbar']['glo_nm_perfil']         = "";
$_SESSION['scriptcase']['menu_navbar']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['menu_navbar']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['menu_navbar']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['menu_navbar']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class menu_navbar_class
{
 ...
 function menu_navbar_menu()
 {
    global $menu_navbar_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['menu_navbar']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_navbar'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_navbar'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_navbar'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_navbar/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_imag_temp'];
$menu_largura   = '99';
$menu_mobile_hide          = 'S';
...
if(function_exists('set_php_timezone')) set_php_timezone('menu_navbar');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_navbar_erro.php");
}
include_once(dirname(__FILE__) . "/menu_navbar_erro.class.php"); 
$this->Erro = new menu_navbar_erro();
$str_path = substr($_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_navbar']['glo_nm_conexao']);
}
/* Definição dos Caminhos */
$menu_navbar_menuData          = array();
$menu_navbar_menuData['path']  = array();
$menu_navbar_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_navbar_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_navbar_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_navbar_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_navbar_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_navbar_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_navbar_menuData['url']['web']   = str_replace("\\", '/', $menu_navbar_menuData['url']['web']);
$menu_navbar_menuData['path']['root'] = substr($menu_navbar_menuData['path']['sys'],  0, -1 * strlen($menu_navbar_menuData['url']['web']));
$menu_navbar_menuData['path']['app']  = substr($menu_navbar_menuData['path']['sys'],  0, strrpos($menu_navbar_menuData['path']['sys'],  '/'));
$menu_navbar_menuData['path']['link'] = substr($menu_navbar_menuData['path']['app'],  0, strrpos($menu_navbar_menuData['path']['app'],  '/'));
$menu_navbar_menuData['path']['link'] = substr($menu_navbar_menuData['path']['link'], 0, strrpos($menu_navbar_menuData['path']['link'], '/')) . '/';
$menu_navbar_menuData['path']['app'] .= '/';
$menu_navbar_menuData['url']['app']   = substr($menu_navbar_menuData['url']['web'],  0, strrpos($menu_navbar_menuData['url']['web'],  '/'));
$menu_navbar_menuData['url']['link']  = substr($menu_navbar_menuData['url']['app'],  0, strrpos($menu_navbar_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_navbar']['glo_nm_usa_grupo'] == "S")
{
    $menu_navbar_menuData['url']['link']  = substr($menu_navbar_menuData['url']['link'], 0, strrpos($menu_navbar_menuData['url']['link'], '/'));
}
$menu_navbar_menuData['url']['link']  .= '/';
$menu_navbar_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['menu_navbar']['sc_apl_link'] = $menu_navbar_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_navbar']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_navbar']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_navbar']['actual_lang']) || $_SESSION['scriptcase']['menu_navbar']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_navbar']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['menu_navbar']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "menu_navbar";
    $_SESSION['scriptcase']['menu_apls']['menu_navbar'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['menu_navbar']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_navbar']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['menu_navbar']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['menu_navbar']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_navbar']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['menu_navbar']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['menu_navbar']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['menu_navbar']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_navbar']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['menu_navbar']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['menu_navbar']['init']))
{
    $_SESSION['sc_session'][1]['menu_navbar']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_navbar']['init'];
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_navbar'] = "on";
} 
if (!isset($_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_navbar']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_navbar'] != "on"))
{ 
...
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
      $_SESSION['scriptcase']['menu_navbar']['contr_erro'] = 'on';
 	



$_SESSION['scriptcase']['menu_navbar']['contr_erro'] = 'off';
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_navbar'))
{
    $_SESSION['sc_session'][1]['menu_navbar']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_navbar'] = "javascript:window.close()";
}

/* Variáveis de Configuração do Menu */
$menu_navbar_menuData['iframe'] = TRUE;

$menu_navbar_menuData['height'] = '100%';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("menu_cima") . "/menu_cima_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_cima']))
    {
...
<head>
 <title><?php echo $this->Nm_lang['lang_v94_menu_fa_title'] ?></title>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_navbar_message.js"></script>
...
<style>
   .scTabText {
   }   .item_1.icon_fa{ color: #228be6 !important}
   .jstree-anchor:hover .item_1.icon_fa{ color: #2c9fff !important}
   .jstree-anchor .item_1.scMenuTItemDisabled.icon_fa{ color: #d2dae2 !important}
   .item_7.icon_fa{ color: #3094db !important}
   .jstree-anchor:hover .item_7.icon_fa{ color: #2c9fff !important}
   .jstree-anchor .item_7.scMenuTItemDisabled.icon_fa{ color: #d2dae2 !important}
   .jstree-anchor .item_8.scMenuTItemDisabled.icon_fa{ color: #d2dae2 !important}
   .item_3.icon_fa{ color: #3094db !important}
   .jstree-anchor:hover .item_3.icon_fa{ color: #2c9fff !important}
   .jstree-anchor .item_3.scMenuTItemDisabled.icon_fa{ color: #d2dae2 !important}
</style>
<script type="text/javascript">
...
?> 
        ...
        <script  type="text/javascript">
                        ...
                        $(document).ready(function () {
                                ...
                                $('#css3menut').jstree({
                                        'state' : { 'key' : 'menu_navbar', 'filter' : function (k) { delete k.core.selected; return k; } },
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_navbar'];
$menu_navbar_menuData['data'] = array();
$nextLevelToBeWrite = false;
$str_disabled = "N";
$str_link = "menu_navbar_form_php.php?sc_item_menu=item_1&sc_apl_menu=menu_cima&sc_apl_link=" . urlencode($menu_navbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_navbar']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_cima']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['menu_cima']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $menu_navbar_menuData['data'][] = array(
        ...
        'target'   => " target=\"" . $this->menu_navbar_target('_self') . "\"",
        'sc_id'    => "item_1",
...
$menu_navbar_menuData['data'][] = array(
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " target=\"" . $this->menu_navbar_target('_parent') . "\"",
    'sc_id'    => "item_3",
    'disabled' => $str_disabled,
    'display'  => "text_fontawesomeicon",
    'display_position'    => "text_right",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_navbar']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_navbar']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_navbar');
    $menu_navbar_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_navbar_help.txt"))
{
    $Arq_WebHelp = file("menu_navbar_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_navbar_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_navbar_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'  => "text",
                    'display_position'    => "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_navbar']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_navbar']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_navbar_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_navbar']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_navbar_menuData['data'][$i_menu]);
       }
    ...
    $menu_navbar_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_navbar']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_navbar']))
{
    $disable_menu = false;
    foreach ($menu_navbar_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_navbar']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_navbar_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_navbar_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_navbar_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_navbar_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_navbar_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_navbar_menuData['data'][$chave]['level'];
                        unset($menu_navbar_menuData['data'][$chave]);
                }
        }
}
$menu_navbar_menuData['data'] = array_values($menu_navbar_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_navbar_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if ($menu_navbar_menuData['data'][$chave]['disabled'] == 'Y')
            {
                    unset($menu_navbar_menuData['data'][$chave]['disabled']);
                    foreach ($menu_navbar_menuData['data'] as $_key => $_val)
                    {
                            if($_key > $chave)
                            {
                                    if($menu_navbar_menuData['data'][$_key]['level'] > $menu_navbar_menuData['data'][$chave]['level'])
                                    {
                                            unset($menu_navbar_menuData['data'][$_key]);
                                    }
                                    else
                                    {
                                            break;
            ...
            if (isset($menu_navbar_menuData['data'][$chave + 1]) && !empty($menu_navbar_menuData['data'][$chave + 1]))
            {
                if ($menu_navbar_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_navbar_menuData['data'][$chave]['level'] >= $menu_navbar_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_navbar_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_navbar_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_navbar_menuData['data'][$chave]);
            }
        }
...
<?php
    $link_default = "";
    if (isset($_SESSION['scriptcase']['sc_apl_seg']['menu_cima']) && $_SESSION['scriptcase']['sc_apl_seg']['menu_cima'] == "on") 
    { 
    $_SESSION['scriptcase']['menu_navbar']['apl_inicial'] = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_navbar');\" item-href=\"menu_navbar_form_php.php?sc_item_menu=menu_navbar&sc_apl_menu=menu_cima&sc_apl_link=" . urlencode($menu_navbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_navbar']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_navbar_iframe\"";
    } 
    else
    { 
        $_SESSION['scriptcase']['menu_navbar']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "menu_navbar_pag_ini.php";
    } 
    $_SESSION['scriptcase']['menu_navbar']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                      ...
                      <?php
                      echo $this->menu_navbar_escreveMenu($menu_navbar_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    <tr>
        ...
        <iframe name="menu_navbar_iframe" id="iframe_menu_navbar" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $_SESSION['scriptcase']['menu_navbar']['apl_inicial']?>"<?php echo $link_default ?>></iframe>
      </tr>
    </table>
</div>
<script type="text/javascript">
...
Iframe_atual = "menu_navbar_iframe";
Tab_links = new Array();
<?php
echo "Tab_links['menu_navbar']   = \"\";\r\n";
 if(isset($menu_navbar_menuData['data']) && !empty($menu_navbar_menuData['data']))
 {
   foreach ($menu_navbar_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_navbar_menuData['data_vertical']) && !empty($menu_navbar_menuData['data_vertical']))
 {
   foreach ($menu_navbar_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         echo "Tab_links['" . $dados_menu['id'] . "']   = \"\";\r\n";
...
{
  if (str_id != "iframe_menu_navbar")
  {
      str_id        = str_id.replace("menu_navbar_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_navbar', 'menu_navbar');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_menu_navbar').length)
        $('#iframe_menu_navbar')[0].contentWindow.focus();
  }
}
...
{
    echo "   document.getElementById('iframe_menu_navbar').click();\r\n";
}
?>
</script>
</body>
...
/* Controle de Target */
function menu_navbar_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
...
/* Controle de Target */
   function menu_navbar_target($str_target)
   {
       global $menu_navbar_menuData;
       ...
       elseif ($menu_navbar_menuData['iframe'])
       {
           return 'menu_navbar_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('menu_navbar_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_navbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_navbar']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "menu_navbar_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_navbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_navbar']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_menu_navbar'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_navbar_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_navbar']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_navbar']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_navbar") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_navbar']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'])) {
            $_SESSION['scriptcase']['menu_navbar']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'];
        }
    }
}
...
$contr_menu_navbar = new menu_navbar_class;
$contr_menu_navbar->menu_navbar_menu();
