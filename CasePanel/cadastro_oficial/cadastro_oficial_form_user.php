...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../_lib/libraries/grp/login/login/css/cadastro.css">
        <link rel="stylesheet" type="text/css" href="../_lib/libraries/grp/login/libs/css/styles.css">
     	      <link rel="icon" type="imagem/png" href= "../_lib/img/login/imgs/favicon.png"/>
    ...
    <body>
        <div id="login1" class="page">
            <div class="header">
                <img src="../_lib/libraries/grp/login/imgs/logo_of.png" alt="FALHA">
            </div>
...
<input type="hidden" name="csrf_token" value="<?php echo $this->scCsrfGetToken() ?>" />
                ...
                <div class="control">
                    ...
                    <input class="input  sc-js-input " type="text" placeholder="Nome"  name="name" id="id_sc_field_name" value="<?php echo $this->form_encode_input($name) ?>"  alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >					
                </div>
				  <div class="control">
                   <!--<label class="form-label"></label>-->
				  ...
				  <div class="control">
                     <!--<label class="form-label"></label>-->
                    <input class="input  sc-js-input " type="text" placeholder="E-mail"  name="email" id="id_sc_field_email" value="<?php echo $this->form_encode_input($email) ?>"  alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >					
                </div>
                <div class="control">
                    <!--<label class="form-label"></label>-->
				  ...
				  <div class="control">
                    <!--<label class="form-label"></label>-->
                    <input class="input  sc-js-input " type="password" placeholder="Confirmar Senha"  name="confpswd" id="id_sc_field_confpswd" value="<?php echo $this->form_encode_input($confpswd) ?>"  alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >					
                </div>
				<!--SC_CAPTCHA-->
				<!--SC_REQUIRED_MSG-->
                <div class="submit">
                    <input class="button button-block" type="button" value="Cadastrar"  onclick="nm_atualiza('alterar');"  />
                </div>
