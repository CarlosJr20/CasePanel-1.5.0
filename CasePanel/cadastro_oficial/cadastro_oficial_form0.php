...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>cadastro_oficial/cadastro_oficial_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("cadastro_oficial_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('cadastro_oficial_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("cadastro_oficial_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['cadastro_oficial'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['cadastro_oficial'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['empty_filter'] = true;
       }
  }
?>
...
<input type="hidden" name="links_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_links('', '_self')">Voltar para login</a>
<?php  } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['confpswd']))
    {
        $this->nm_new_label['confpswd'] = "Confpswd";
    }
?>
<?php
   ...
   $sStyleHidden_confpswd = '';
   if (isset($this->nmgp_cmp_hidden['confpswd']) && $this->nmgp_cmp_hidden['confpswd'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['confpswd']);
       $sStyleHidden_confpswd = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_confpswd = 'display: none;';
   $sStyleReadInp_confpswd = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['confpswd']) && $this->nmgp_cmp_readonly['confpswd'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['confpswd']);
       $sStyleReadLab_confpswd = '';
       $sStyleReadInp_confpswd = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['confpswd']) && $this->nmgp_cmp_hidden['confpswd'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="confpswd" value="<?php echo $this->form_encode_input($confpswd) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_confpswd_label" id="hidden_field_label_confpswd" style="<?php echo $sStyleHidden_confpswd; ?>"><span id="id_label_confpswd"><?php echo $this->nm_new_label['confpswd']; ?></span></TD>
    <TD class="scFormDataOdd css_confpswd_line" id="hidden_field_data_confpswd" style="<?php echo $sStyleHidden_confpswd; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_confpswd_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["confpswd"]) &&  $this->nmgp_cmp_readonly["confpswd"] == "on") { ?>
<input type="hidden" name="confpswd" value="">
<?php } else { ?>
<span id="id_read_on_confpswd" class="sc-ui-readonly-confpswd css_confpswd_line" style="<?php echo $sStyleReadLab_confpswd; ?>"><?php echo $this->form_format_readonly("confpswd", $this->form_encode_input($this->confpswd)); ?></span><span id="id_read_off_confpswd" class="css_read_off_confpswd<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_confpswd; ?>"><input class="sc-js-input scFormObjectOdd css_confpswd_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_confpswd" type="password" autocomplete="off" name="confpswd" value="" 
...
</td><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none; position: absolute" id="id_error_display_confpswd_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_confpswd_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<span id="id_read_on_name" class="sc-ui-readonly-name css_name_line" style="<?php echo $sStyleReadLab_name; ?>"><?php echo $this->form_format_readonly("name", $this->form_encode_input($this->name)); ?></span><span id="id_read_off_name" class="css_read_off_name<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_name; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none; position: absolute" id="id_error_display_name_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_name_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("cadastro_oficial");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("cadastro_oficial");
 parent.scAjaxDetailHeight("cadastro_oficial", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['cadastro_oficial']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
