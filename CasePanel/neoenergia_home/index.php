...
include_once('neoenergia_home_session.php');
@ini_set('session.cookie_httponly', 1);
@ini_set('session.use_only_cookies', 1);
@ini_set('session.cookie_secure', 0);
@session_start();

$_SESSION['scriptcase']['neoenergia_home']['glo_nm_perfil']          = "host_oficial";
$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_prod']       = "";
$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imagens']    = "";
$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imag_temp']  = "";
$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_doc']        = "";
...
//check prod
if(empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_neoenergia_home($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "neoenergia_home") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'])) {
            $_SESSION['scriptcase']['neoenergia_home']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_neoenergia_home($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['neoenergia_home']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['neoenergia_home']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$neoenergia_home_control = new neoenergia_home_control();
$neoenergia_home_control->control();

class neoenergia_home_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['neoenergia_home'])) {
            $_SESSION['sc_session'][$this->sc_page]['neoenergia_home'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "neoenergia_home";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->nm_hr_criacao   = "213840";
        $this->nm_autor_alt    = "admin";
        $this->nm_dt_ult_alt   = "20210216";
        $this->nm_hr_ult_alt   = "032645";
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['neoenergia_home']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/neoenergia_home';
        ...
        if (isset($_SESSION['scriptcase']['neoenergia_home']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['neoenergia_home']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['neoenergia_home']['actual_lang']) || $_SESSION['scriptcase']['neoenergia_home']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['neoenergia_home']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir'])) {
            ...
            if ($_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['neoenergia_home']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['neoenergia_home']['session_timeout']);
        ...
        $this->str_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "neoenergia_tema/neoenergia_tema";
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao']) && $_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['neoenergia_home']['glo_nm_perfil']) && $_SESSION['scriptcase']['neoenergia_home']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['neoenergia_home']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['neoenergia_home']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['neoenergia_home']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['neoenergia_home']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['neoenergia_home']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['SC_sep_date1'];
      }
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['neoenergia_home']['sc_outra_jan'] != 'neoenergia_home')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao'], $this->root . $this->path_prod, 'Web_Case_IoT_V_1_12', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['neoenergia_home']['glo_nm_conexao'], $this->root . $this->path_prod, 'Web_Case_IoT_V_1_12', 1, $this->force_db_utf8);
    }
    else {
...
class neoenergia_home_control {
    ...
    function init()
    {
        ...
        {
            include_once(dirname(__FILE__) . '/neoenergia_home_json.php');
        }
        if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "refreshWidget")
        {
            ob_start();
        ...
        if (!$this->Ini)
        {
            $this->Ini = new neoenergia_home_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['neoenergia_home'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['neoenergia_home'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home']['dbifrm_widget1'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home']['dbifrm_widget2'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home']['dbifrm_widget3'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home']['dbifrm_widget4'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home']['dbifrm_widget5'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home']['dbifrm_widget6'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['neoenergia_home'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['neoenergia_home']['neoenergia_funcionario'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['neoenergia_home']['neoenergia_produto'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['neoenergia_home']['neoenergia_lancamento'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="neoenergia_home_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['neoenergia_home'] as $sIframe => $iSCInit) {
?>
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="4" data-gs-width="6" data-gs-height="10"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head widget-is-moveable" style="display:none">
                            <h3 class="scContainerTitle">Funcionário</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('neoenergia_funcionario'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["neoenergia_home"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=neoenergia_home&own_widget=dbifrm_widget1&compact_mode=0&remove_margin=0&remove_border=0" alt="100"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="4" data-gs-width="6" data-gs-height="10"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head widget-is-moveable" style="display:none">
                            <h3 class="scContainerTitle">Produto</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('neoenergia_produto'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["neoenergia_home"]["dbifrm_widget2"] ?>&under_dashboard=1&dashboard_app=neoenergia_home&own_widget=dbifrm_widget2&compact_mode=0&remove_margin=0&remove_border=0" alt="100"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="4" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-2">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-2">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Quantidade de produto cadastrado</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="0" data-gs-width="4" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-3">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-3">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Quantidade de funcionário cadastrado</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="8" data-gs-y="0" data-gs-width="4" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-4">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-4">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">Produtos lançados</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="14" data-gs-width="12" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-5">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-5">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">lançamento</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-5"><iframe id="id-iframe-5" name="dbifrm_widget6" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('neoenergia_lancamento'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["neoenergia_home"]["dbifrm_widget6"] ?>&under_dashboard=1&dashboard_app=neoenergia_home&own_widget=dbifrm_widget6&compact_mode=0&remove_margin=0&remove_border=0" alt="100"></iframe></div>
                    </div>
                </div></div>
...
<script type="text/javascript">
 $( document ).ready(function() {
    setTimeout(function() { refreshWidgetIndex('widget3', '2', 50000); }, 50000);
    setTimeout(function() { refreshWidgetIndex('widget4', '3', 50000); }, 50000);
    setTimeout(function() { refreshWidgetIndex('widget5', '4', 50000); }, 50000);
 });
 function refreshWidgetIndex(wId, seq, wRef)
 {    $.ajax({
      type: "POST",
      url: 'neoenergia_home.php',
...
<?php
    ...
    function getIndexContentData_widget3() {
        ...
        {
            $sSql = "SELECT COUNT(produto) FROM neoenergia_produto";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget3"><img src="{$this->Ini->path_imag_cab}/sys__NM__ico__NM__prancheta (6).png" /><br />Quantidade de produtos cadastrados</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget4() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(nome) FROM neoenergia_funcionario";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"nome\") FROM neoenergia_funcionario";
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget4"><img src="{$this->Ini->path_imag_cab}/sys__NM__ico__NM__equipe.png" /><br />Quantidade de funcionários cadastrados</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget5() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(produto) FROM neoenergia_lancamento";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"produto\") FROM neoenergia_lancamento";
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget5"><img src="{$this->Ini->path_imag_cab}/sys__NM__ico__NM__produtos.png" /><br />Quantidade de produtos   lançados</span></div>
...
} // neoenergia_home_control

function nm_limpa_str_neoenergia_home(&$str)
{
