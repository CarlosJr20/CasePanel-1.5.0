<?php
@session_start() ;
$_SESSION['scriptcase']['chart_historico']['sc_process_barr'] = true;
require_once('../chart_historico/index.php');
unset($_SESSION['scriptcase']['chart_historico']['sc_process_barr']);
$ExportCtrl = new chart_historico_export_control;
$ExportCtrl->Export_barr();

class chart_historico_export_control
{
