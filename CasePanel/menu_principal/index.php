...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_principal']['glo_nm_perfil']         = "host_oficial";
...
$_SESSION['scriptcase']['menu_principal']['sc_apl_link'] = $menu_principal_menuData['url']['link'];
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_principal']['glo_nm_path_prod']);
...
{
    db_conect_devel($_SESSION['scriptcase']['menu_principal']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_principal']['glo_nm_path_prod'], 'Web_Case_IoT_V_1_12', 2); 
}
if (isset($_SESSION['scriptcase']['menu_principal']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_principal']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_principal']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_principal']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_principal']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_principal']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_principal']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_principal']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_principal']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu_principal']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_principal']['glo_nm_path_prod'], 'Web_Case_IoT_V_1_12'); 
} 
else 
{ 
...
{
    $_SESSION['scriptcase']['sc_menu_del']['menu_principal'][] = trim($Cada_del);
}
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("graficos_trial") . "/graficos_trial_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("graficos_trial") . "/graficos_trial_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['graficos_trial']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['graficos_trial'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$menu_principal_menuData['data'] .= "item_22|.|" . $nm_var_lab[0] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $menu_principal_menuData['data'] .= "item_25|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_principal_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
...
{
    $menu_principal_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|menu_principal_form_php.php?sc_item_menu=item_32&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
...
{
    $menu_principal_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_principal_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $menu_principal_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_principal_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) == "on")
{
    $menu_principal_menuData['data'] .= "item_30|..|" . $this->Nm_lang['lang_logged_users'] . "|menu_principal_form_php.php?sc_item_menu=item_30&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_logged_users'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_principal_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_principal_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_principal_menuData['data'] .= "item_29|..|" . $this->Nm_lang['lang_exit'] . "|menu_principal_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_principal_target('_parent') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['graficos_trial']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['graficos_trial']) == "on")
{
    $menu_principal_menuData['data'] .= "item_33|.|" . $nm_var_lab[1] . "|menu_principal_form_php.php?sc_item_menu=item_33&sc_apl_menu=graficos_trial&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

$menu_principal_menuData['data'] .= "item_11|..|" . $nm_var_lab[2] . "||" . $nm_var_hint[1] . "||_self|\n";
...
{
    $menu_principal_menuData['data'] .= "item_12|...|" . $nm_var_lab[3] . "|menu_principal_form_php.php?sc_item_menu=item_12&sc_apl_menu=grafico_corrente_maior&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
...
{
    $menu_principal_menuData['data'] .= "item_16|...|" . $nm_var_lab[4] . "|menu_principal_form_php.php?sc_item_menu=item_16&sc_apl_menu=grafico_consumo_maior&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

$menu_principal_menuData['data'] .= "item_35|..|" . $nm_var_lab[5] . "||" . $nm_var_hint[4] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) == "on")
{
    $menu_principal_menuData['data'] .= "item_36|...|" . $nm_var_lab[6] . "|menu_principal_form_php.php?sc_item_menu=item_36&sc_apl_menu=historico_nivel&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) == "on")
{
    $menu_principal_menuData['data'] .= "item_37|...|" . $nm_var_lab[7] . "|menu_principal_form_php.php?sc_item_menu=item_37&sc_apl_menu=historico_volume&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

$menu_principal_menuData['data'] .= "item_4|.|" . $_SESSION['usr_name'] . "||" . $nm_var_hint[7] . "|scriptcase__NM__bg__NM__admin_proj.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_principal_menuData['data'] .= "item_9|..|" . $nm_var_lab[8] . "|menu_principal_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_principal_menuData['data'] .= "item_6|..|" . $nm_var_lab[9] . "|menu_principal_form_php.php?sc_item_menu=item_6&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_principal_target('_parent') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_32&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_30&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_33&sc_apl_menu=graficos_trial&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['graficos_trial']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['graficos_trial']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_12&sc_apl_menu=grafico_corrente_maior&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_corrente_maior']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_corrente_maior']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_16&sc_apl_menu=grafico_consumo_maior&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grafico_consumo_maior']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grafico_consumo_maior']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_36&sc_apl_menu=historico_nivel&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_nivel']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_37&sc_apl_menu=historico_volume&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['historico_volume']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_6&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
foreach ($menu_principal_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_principal_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_principal_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_principal_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_principal_menuData['data'][$chave]['level'];
                        unset($menu_principal_menuData['data'][$chave]);
                }
        }
}
$menu_principal_menuData['data'] = array_values($menu_principal_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_principal_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($menu_principal_menuData['data'][$chave + 1]) && !empty($menu_principal_menuData['data'][$chave + 1]))
            {
                if ($menu_principal_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_principal_menuData['data'][$chave]['level'] >= $menu_principal_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_principal_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_principal_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_principal_menuData['data'][$chave]);
            }
        }
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_principal']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_principal']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_principal']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_principal_message.js"></script>
...
echo "Tab_labels['menu_principal'] = \"  Home\";\r\n";
echo "Tab_hints['menu_principal'] = \"  Home\";\r\n";
...
echo "Tab_icon_fa['menu_principal']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_principal']   = \"\";\r\n";
echo "Tab_display['menu_principal']   = \"\";\r\n";
echo "Tab_display_position['menu_principal']   = \"\";\r\n";
echo "Tab_links['menu_principal']   = \"\";\r\n";
         $seq++;
 if(isset($menu_principal_menuData['data']) && !empty($menu_principal_menuData['data']))
 {
 ...
 if(isset($menu_principal_menuData['data_vertical']) && !empty($menu_principal_menuData['data_vertical']))
 {
   foreach ($menu_principal_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            if (Tab_iframes[i] != 'menu_principal') 
            {
...
{
    if(str_id === 'menu_principal') { return false; }
    ...
    if (Aba_atual == str_id)
    {
        ...
        if (str_id == "" && Aba_atual != "menu_principal")
        {
            document.getElementById('iframe_menu_principal').click();
        }
        else
        {
            mudaIframe(str_id);
        ...
        }function openMenuItem(str_id)
{
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_menu_principal').length)
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_principal');\" item-href=\"menu_principal_form_php.php?sc_item_menu=menu_principal&sc_apl_menu=WEBCASEIoT&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_principal_iframe\"";
} 
else
{ 
...
?>
        ...
        </td>        <td class='sc-layer-6' style='width:12.57%;text-align:left;'>
        ...
        </td>        <td class='sc-layer-18' style='width:54.57%;text-align:left;'>
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('menu_principal_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_principal']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_principal']['glo_nm_path_imag_temp'] . "/sc_apl_default_Web_Case_IoT_V_1_12.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'])) {
            $_SESSION['scriptcase']['menu_principal']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Web_Case_IoT_V_1_12'];
        }
    }
}
