...
<html>
    ...
    <style>
    <?php
    if(isset($menu_principal_menuData["data"]) && is_array($menu_principal_menuData["data"]) && !empty($menu_principal_menuData["data"]))
    {
        foreach($menu_principal_menuData["data"] as $arr_item)
        {
