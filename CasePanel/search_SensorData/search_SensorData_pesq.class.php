...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "value1";$Nm_numeric[] = "value2";$Nm_numeric[] = "value3";
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> SensorData</TITLE>
...
<INPUT  type="text" id="SC_id_IN" name="id_IN" value="<?php echo NM_encode_input($id_IN) ?>" size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd"<?php echo $style_cond_in ?>>        </TD>
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_value1_cond" name="value1_cond" onChange="nm_campos_between(document.getElementById('id_vis_value1'), this, 'value1')">
...
<INPUT  type="text" id="SC_value1" name="value1" value="<?php echo NM_encode_input($value1) ?>" size=10 alt="{datatype: 'decimal', maxLength: 10, precision: 4, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_value2_cond" name="value2_cond" onChange="nm_campos_between(document.getElementById('id_vis_value2'), this, 'value2')">
