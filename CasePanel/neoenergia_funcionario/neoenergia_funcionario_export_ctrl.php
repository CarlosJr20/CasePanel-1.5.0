<?php
@session_start() ;
$_SESSION['scriptcase']['neoenergia_funcionario']['sc_process_barr'] = true;
require_once('../neoenergia_funcionario/index.php');
unset($_SESSION['scriptcase']['neoenergia_funcionario']['sc_process_barr']);
$ExportCtrl = new neoenergia_funcionario_export_control;
$ExportCtrl->Export_barr();

class neoenergia_funcionario_export_control
{
