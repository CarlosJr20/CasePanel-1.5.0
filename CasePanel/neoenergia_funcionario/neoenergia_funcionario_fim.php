...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____neoenergia_funcionario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Web_Case_IoT_V_1_12_____neoenergia_funcionario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['neoenergia_funcionario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['neoenergia_funcionario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['neoenergia_funcionario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['neoenergia_funcionario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['neoenergia_funcionario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>neoenergia_funcionario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['neoenergia_funcionario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['neoenergia_funcionario']['embutida_filho'] as $ind => $sc_init)
          {
